...
public class StreamPersistanceTests {
  ...
  public void testaddStreamThrowsExceptionOnInvalidInputPortForLoggerType() {
    ...
    // TODO: Add Test for non matching input port type to source
  }
  ...
  private void runLocalClusterAndValidate(LogicalPlan dag, final TestRecieverOperator x, TestPersistanceOperator logger) throws IOException, ClassNotFoundException {
  ...
  public void testPersistStreamOperatorGeneratesUnionOfAllSinksOutput() throws ClassNotFoundException, IOException {
    ...
    String[] expectedResult = { "0", "2", "3", "4", "6", "8", "9", "10", "12" };
